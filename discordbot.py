...
async def RED(ctx):
    await ctx.send(f"ｸｩｩﾚﾅｲｨｨﾆｿｫｫﾏｧｯﾀｱｧｧｸｫｫｵﾉｳｫｵﾚｪｲｳｫｫwwwwﾇｧｧｱｸﾞｻﾑｪｴｴﾙｳｨﾔｱｧｧﾂｩｩﾜｱｱｱﾑｩｵｫｫｩｫｲｨﾅｧｳｨｨwwwwﾓｫｫｫｳﾆｨﾄﾞﾄｫｫｫﾄﾄﾞｫｶﾅｲｨｨｨｨｺｫﾉｵﾓｲｨｨwwww")

@bot.command(name="hello")
async def hello(ctx):
    await ctx.send(f"ハローキティ～！できたてのポップコーンはいかが？キティはみんなのにんkできたてのポップコーンはいかが？わんぱく！いじわる！おこりんぼうも～！やさしいキティといっしょなら～つられてやさしくなあっちゃうの～お゛ッ！")
